        ...
        <div className="relative z-20 mx-auto max-w-5xl rounded-[40px] py-6 md:p-10 xl:py-20">
          ...
          <div className="space-y-4 md:space-y-6">
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              SALAVAT — это сеть автозаправочных станций, которая работает для вас каждый день. Мы стараемся сделать каждую заправку быстрой, комфортной и честной — без переплат и очередей.
            </p>
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Ваше мнение важно для нас. Мы читаем каждый отзыв и отвечаем лично — потому что именно обратная связь помогает нам становиться лучше с каждым днём.
            </p>
          </div>
        </div>
      </div>
